...
export interface ApiKeyServiceClient {
  ...
  getApiKey(request: GetApiKeyRequest): Observable<GetApiKeyResponse>;
...
export interface ApiKeyDbServiceClient {
  ...
  getAllApiKeys(request: GetAllApiKeysParams): Observable<GetAllApiKeysResult>;
...
export interface ApiKeyDbServiceController {
  ...
  getAllApiKeys(
    request: GetAllApiKeysParams,
  ):
    | Promise<GetAllApiKeysResult>
    | Observable<GetAllApiKeysResult>
    | GetAllApiKeysResult;
