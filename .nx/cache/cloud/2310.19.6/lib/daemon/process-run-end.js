      ...
      r
        ...
        .forEach(function (i, n) {
          ...
          if (o != null) {
            ...
            t &&
              Ea(
                `did not match key and value when parsing line ${n + 1}: ${i}`,
              );
        }),
      s
    );
...
function $t(r, e = 1e4) {
  ...
  if (r.customProxyConfigPath) {
    let { nxCloudProxyConfig: n } = require(
      (0, su.join)(process.cwd(), r.customProxyConfigPath),
    );
    t = n ?? t;
  }
  return Op.create(
      ...
      (Yo = class {
        constructor(e, t, s, i) {
          ...
          if (s.customProxyConfigPath) {
            let { fileServerProxyConfig: n } = require(
              (0, Xh.join)(process.cwd(), s.customProxyConfigPath),
            );
