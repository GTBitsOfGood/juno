      ...
      r
        ...
        .forEach(function (i, s) {
          ...
          if (o != null) {
            ...
            t &&
              eh(
                `did not match key and value when parsing line ${s + 1}: ${i}`,
              );
        }),
      n
    );
...
function Te(r, e = 1e4) {
  ...
  if (r.customProxyConfigPath) {
    let { nxCloudProxyConfig: s } = require(
      (0, Hd.join)(process.cwd(), r.customProxyConfigPath),
    );
    t = s ?? t;
  }
  return XS.create(
        ...
        constructor(e, t, n, i) {
          ...
          if (n.customProxyConfigPath) {
            let { fileServerProxyConfig: s } = require(
              (0, Py.join)(process.cwd(), n.customProxyConfigPath),
            );
